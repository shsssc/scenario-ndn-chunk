  ...
  , m_options(opts)
{
  ...
  m_face.setInterestFilter(m_versionedPrefix, bind(&Producer::processSegmentInterest, this, _2));
  ...
  m_face.setInterestFilter(MetadataObject::makeDiscoveryInterest(m_prefix).getName(),
