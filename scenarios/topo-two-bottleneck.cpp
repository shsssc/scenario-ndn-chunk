...
void queueSizeTrace(Ptr<Node> node) {
  ...
  node->GetDevice(0)->GetAttribute("TxQueue", txQueue);//todo: this is not always 0
...
main(int argc, char *argv[]) {
  ...
  topologyReader.SetFileName("scenarios/topo-two-bottleneck.txt");
  topologyReader.Read();
